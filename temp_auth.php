...
class AuthController extends Controller
{
     ...
     * The actual User record is NOT created here ΓÇö it is created in verifyRegistration()
    ...
    public function register(Request $request)
    {
        ...
        // Store ID photos to a staging folder ΓÇö moved to resident_ids/ after verification
    ...
    public function login(Request $request)
    {
        ...
        if ($user->role === 'admin') {
            ...
            // Known/trusted device ΓÇö no verification needed
            $deviceTrusted = true;
            $user->trustDevice($deviceToken, $request); // update last_used_at
        } else {
            // New/unknown device ΓÇö send verification code for identity confirmation.
