...
export function CommentItem({
    ...
    onDelete,
    onUpdate,
    onRepliesUpdate, // Added to sync replies
    threadParentId, // Root of the specific comment thread
    onSetReplyTarget, // New prop to unify input
}) {
...
export default function CommentModal({
    ...
    const syncToParent = (updatedComments) => {
        if (onUpdate) {
            // Calculate total count (comments + replies)
                    ...
                    {totalReactions > 0 && (
                        <div className="stat-reactions">
                            <div className="reaction-icons">
                                ...
                                {reactionsSummary.love > 0 && <span>❤️</span>}
                                {reactionsSummary.haha > 0 && <span>😆</span>}
                            </div>
