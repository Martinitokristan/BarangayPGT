...
export default function Notifications() {
    ...
    const typeIcons: Record<string, { icon: React.ReactNode; className: string }> = {
        urgent_post: {
                    ...
                    {notifications.map((notification, index) => (
                        ...
                        >
                            ...
                            <div className="notification-content">
                                <strong>{(notification as any).title}</strong>
                            ...
                            {(notification as any).post_id && (
                                <Link
                                    href={`/posts/${(notification as any).post_id}`}
